...
class SlicerBS(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SlicerBS"  # TODO: make this more human readable by adding spaces
...
def registerSampleData():
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    ...
    category='SlicerBS',
    sampleName='SlicerBS1',
    # Thumbnail should have size of approximately 260x280 pixels and stored in Resources/Icons folder.
    # It can be created by Screen Capture module, "Capture all views" option enabled, "Number of images" set to "Single".
    thumbnailFileName=os.path.join(iconsPath, 'SlicerBS.png'),
    # Download URL and target file name
    uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
    fileNames='SlicerBS1.nrrd',
...
class SlicerBSWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/SlicerBS.ui'))
  ...
  def onApplyButton(self):
    ...
    try:
      ...
      self.logic.process(self.ui.inputSelector.currentNode(), self.ui.outputSelector.currentNode(),
        self.ui.bepSliderWidget.value, self.ui.qParameterctkSliderWidget.value, self.ui.alphactkSliderWidget.value,
        self.ui.betactkSliderWidget.value, self.ui.gammactkSliderWidget.value, self.ui.iterationctkSliderWidget.value,
        self.ui.onlyExtractBrainctkCheckBox.checked)
...
class SlicerBSLogic(ScriptedLoadableModuleLogic):
  ...
  def process(self, inputVolume, outputVolume, bep, q, alpha, beta, gamma, Iteration , onlymask=False, showResult=True):
    ...
    ext = Extractor()
    t1Array =slicer.util.array(inputVolume.GetID())
    ...
    if onlymask:
        ...
        outputVolume = volumesLogic.CreateLabelVolumeFromVolume(slicer.mrmlScene, outputVolume,inputVolume )
        ...
        #print(os.path.dirname(os.path.realpath(__file__))+'\Resources\Atlas.nii.gz')
        ...
        Atlas_registered, label_registered =Register_7DOF(sitk.GetImageFromArray(brain),Atlas,Atlas_label)
    ...
    #outputVolume=slicer.util.addVolumeFromArray(label_map)
...
class SlicerBSTest(ScriptedLoadableModuleTest):
  """
  ...
  def test_SlicerBS1(self):
  
    # self.delayDisplay("Starting the test")
    # # Get/create input data
    # import SampleData
    # registerSampleData()
    # inputVolume = SampleData.downloadSample('BS1')
