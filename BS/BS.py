...
class BS(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "BS"  # TODO: make this more human readable by adding spaces
...
def registerSampleData():
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    ...
    thumbnailFileName=os.path.join(iconsPath, 'BS1.png'),
...
class BSWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/BS.ui'))
...
class BSLogic(ScriptedLoadableModuleLogic):
...
class BSTest(ScriptedLoadableModuleTest):
  """
